    ...
    public class ProblemMetaData
    {
        ...
        public ProblemMetaData(Global.Problems problemID)
        {
            ...
            */
            ...
            {
                throw new SortingException("It seems Id attribute of Problem element has been changed in ProblemDescription.xml or some element is deleted. Please do not change the content of the xml");
            }
        }
        #endregion
        ...
        public string GetName()
        {
            ...
            {
                throw new SortingException("It seems Name element of the particular Problem is deleted in ProblemDescription.xml. Please do not change the content of the xml");
            }
        }
        ...
        public string GetDescription()
        {
            ...
            {
                throw new SortingException("It seems Description element of the particular Problem is deleted in ProblemDescription.xml. Please do not change the content of the xml");
            }
        }
        ...
        public string GetInstruction()
        {
            ...
            {
                throw new SortingException("It seems Instruction element of the particular Problem is deleted in ProblemDescription.xml. Please do not change the content of the xml");
            }
        }
        ...
        public int GetDefaultVariant()
        {
            try
            {
                return Convert.ToInt32(problemElement.Element("Variants").Elements("Method").Where(node => node.Attribute("Default") != null
                    && node.Attribute("Default").Value.Equals("True", StringComparison.OrdinalIgnoreCase)).First().Attribute("Id").Value);
            }
            catch
            {
                throw new SortingException("It seems Default attribute has been removed/changed in Implementation element of the particular Problem in ProblemDescription.xml. Please do not change the content of the xml");
            }
        ...
        public Dictionary<int, string> GetVariants()
        {
            try
            {
                return (from method in problemElement.Element("Variants").Elements("Method")
                        select new { key = int.Parse(method.Attribute("Id").Value), value = method.Attribute("Name").Value }).ToDictionary(e => e.key, e => e.value);
            }
            catch
            {
                throw new SortingException("It seems Implementation element of the particular Problem has been changed in ProblemDescription.xml. Please do not change the content of the xml");
            }
        }
        #endregion
        ...
        public static Dictionary<Global.Problems, string> GetProblems()
        {
            ...
            {
                throw new SortingException("It seems some elements have been changed in ProblemDescription.xml. Please do not change the content of the xml file.");
            }
        }
        #endregion
    }
